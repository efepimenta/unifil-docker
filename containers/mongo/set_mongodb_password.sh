...
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"chat"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"chasuser"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"chatpass"}
